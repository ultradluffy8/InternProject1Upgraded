...
class Chemistry_Player : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_chemistry__player)
    ...
    fun mathData(data_list : ArrayList<math_data>){
        ...
        data_list.add(math_data(youtube_player8,"XWPheDUdMzI"))
        data_list.add(math_data(youtube_player9,"tlSJCG5DqzI"))
    }
