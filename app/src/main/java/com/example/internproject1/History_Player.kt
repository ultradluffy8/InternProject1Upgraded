...
class History_Player : AppCompatActivity() {lateinit var youtube_player1 : YouTubePlayerView
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_history__player)
    ...
    fun mathData(data_list : ArrayList<math_data>){
        data_list.add(math_data(youtube_player1,"2rSqRBPCAPE"))
        data_list.add(math_data(youtube_player2,"Qm9OjiShKCg"))
        data_list.add(math_data(youtube_player3,"TqR4kSaXI9c"))
        data_list.add(math_data(youtube_player4,"PkbiyX1JbSA"))
        data_list.add(math_data(youtube_player5,"IegGPkamqqQ"))
        data_list.add(math_data(youtube_player6,"aLrrVSOo5BQ"))
        data_list.add(math_data(youtube_player7,"UIPlpm2UNeQ"))
        data_list.add(math_data(youtube_player8,"rJB5LyTKdMU"))
        data_list.add(math_data(youtube_player9,"jpENrIFV-Us"))
    }
