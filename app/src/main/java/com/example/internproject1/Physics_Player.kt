...
class Physics_Player : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_physics__player)
    ...
    fun mathData(data_list : ArrayList<math_data>){
        data_list.add(math_data(youtube_player1,"ihNZlp7iUHE"))
        data_list.add(math_data(youtube_player2,"oRKxmXwLvUU"))
        data_list.add(math_data(youtube_player3,"awzOvyMKeMA"))
        data_list.add(math_data(youtube_player4,"lQ-dvt3V4yQ"))
        data_list.add(math_data(youtube_player5,"FOkQszg1-j"))
        data_list.add(math_data(youtube_player6,"CQYELiTtUs"))
        data_list.add(math_data(youtube_player7,"ou9YMWlJgkE"))
        data_list.add(math_data(youtube_player8,"By-ggTfeuJU"))
        data_list.add(math_data(youtube_player9,"p4DTormtEG0"))
    }
